...
namespace Pacenstein {
    ...
    protected:
        ...
        std::vector<PacPellet> pellets = {
                                          ...
                                          {2.5, 15.5}, {4.5, 15.5}, {5.5, 15.5}, {6.5, 15.5}, {7.5, 15.5}, {8.5, 15.5}, {9.5, 15.5}, {10.5, 15.5}, {11.5, 15.5}, {12.5, 15.5}, {13.5, 15.5}, {14.5, 15.5}, {16.5, 15.5}, 
        ...
        std::vector<PowerPellet> power = {{17.5, 2.5}, {1.5, 15.5}, {17.5, 15.5}};// {1.5, 2.5}, 
